...
@Injectable()
export class UsersJSONService implements OnModuleInit {
  ...
  private readJSON(): {
    ...
    const filePath =
      'C:/Users/User/nest-exam/src/modules/users/usersJSON/users.json';
    const data = fs.readFileSync(filePath, 'utf-8');
    return JSON.parse(data);
  }

  public async importUsersJSON(): Promise<void> {
